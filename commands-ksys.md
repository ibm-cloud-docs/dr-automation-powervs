...
The backup VM rename feature allows you to specify a custom name for the backup VM created at the target site.
...
> **Note:** Ensure that the virtual machine is available in the workspace and can be managed by using the `ksysmgr manage vm` command.
