...
> **Note:**
>
> - A Planned Move involves shutting down the VM on the currently active site and starting the backup VM on the target site. This process results in a temporary disruption at the active site.
